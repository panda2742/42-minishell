...
override	SRC_UTILS		:=	$(addprefix parsing/, count_arg_words free_str_return_null ft_split_parser ft_str_join_free ft_strcmp get_first_word handle_is_redir_token is_redir join_token_to_string print_t_token_list skip_spaces token_lstsize) \
								empty_tab \
								ft_sprintf
