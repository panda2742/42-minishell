...
/*   Updated: 2025/04/09 15:20:30 by abonifac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv, char **env)
{
    ...
    t_env_manager   minishell;    // Gestionnaire d'environnement (alloue et initialise via create_env)
    ...
    while (1)
    {
        ...
        // Ici, on a dejà la phase d'expansion dans chaque token, et on affiche le resultat d'expansion
        // On applique ensuite le word splitting sur chaque token. 
        // Ici, word_split_token() reçoit un token et son environnement, et retourne une nouvelle chaine de tokens
        t_token *tmp = token;
        new_tokens = NULL;
